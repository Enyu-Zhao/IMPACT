    ...
    def find_path(self, start_pos, max_iterations=200, max_cost=10):
        ...
        for _ in tqdm(range(max_iterations)):
            ...
            if is_free_node(new_position, self.voxel_grid, max_cost):
                ...
                node_distance = world_distance(new_position, nearest_node, self.voxel_size, self.origin, VoxelGridNode) / 100
                if is_free_edge(nearest_node.position, new_position, self.voxel_grid, max_cost):
                    new_node.cost = nearest_node.cost + node_distance
